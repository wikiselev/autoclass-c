...
source("/bi/group/sysgen/mikhail/pl/plot_class_heatmap.R")

autoclass.path = "/bi/group/sysgen/autoclass-c/autoclass"
autoclass2tab.path = "/bi/group/sysgen/mikhail/pl/autoclass2tab.pl"
templates = "/bi/group/sysgen/mikhail/pl/autoclass_files/"
...
autoclass = function (data,
  ...
  if (scale == TRUE){
	...
	if(ok==FALSE){
		stop ("copying of sample.db2 to", paste(getwd(), db.2name,sep="/"), "returned an error")
	}
